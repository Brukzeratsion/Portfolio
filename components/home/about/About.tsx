        ...
        <div>
          <Reveal>
            <p className={`${styles.aboutText} ${styles.highlightFirstLetter}`}>
              Howdy! I&apos;m Bruk Zeratsion, and I&apos;m a Marketing
              Management graduate and also Evangadi Full stack bootcamp
              graduate.
              <br />
              <br />I have experience working in both the mobile and web
              development worlds. I&apos;m passionate about creating beautiful,
          ...
          <Reveal>
            <p className={styles.aboutText}>
              ...
              backend technologies like Node.js, Firebase, and MySQL , allowing
              me to build full-stack applications.
            </p>
          </Reveal>
          <Reveal>
            <p className={styles.aboutText}>
              When I&apos;m not coding, I enjoy video editing. I believe that
